...
get_frontend_port() {
  ...
  print_banner
  printf "${WHITE} 💻 Digite a porta do FRONTEND para esta instancia; Ex: 3000 ${GRAY_LIGHT}"
  printf "\n\n"
...
get_backend_port() {
  ...
  print_banner
  printf "${WHITE} 💻 Digite a porta do BACKEND para esta instancia; Ex: 4000 ${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " backend_port
}
...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao instalador S.I. Whaticket, Selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [1] Instalar o S.I. Whaticket\n"
