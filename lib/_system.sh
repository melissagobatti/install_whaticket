...
system_git_clone() {
  ...
  git config --global --add safe.directory /home/deploy/${instancia_add}
...
system_update() {
  print_banner
  printf "${WHITE} 💻 Vamos atualizar o sistema operacional...${GRAY_LIGHT}"
  printf "\n\n"
...
system_chrome_install() {
  print_banner
  printf "${WHITE} 💻 Instalando Google Chrome ...${GRAY_LIGHT}"
  printf "\n\n"
...
system_mysql_install() {
  print_banner
  printf "${WHITE} 💻 Instalando MySQL 8.x...${GRAY_LIGHT}"
  printf "\n\n"
